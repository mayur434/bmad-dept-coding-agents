/**
 * EDS + Commerce Hybrid — Architecture Design Engine (Phase 2.4 stub)
 * =================================================================
  ...
  const findings: Finding[] = [
    {
      ...
      description:
        "Phase 2.4 scaffold. Content agent fills this in Phase 2.5 (ADR templates, HLD/LLD generators, OpenAPI/GraphQL contracts, C4 + sequence diagrams, STRIDE threat models, and eds-commerce-native data models).",
      stack: STACK,
