/**
 * Generation — SLA gate helper (Phase 1.4).
 * ==========================================
 ...
 *
 * Generation produces no findings today, so `applySLA` is effectively a
 * no-op for this agent — kept for symmetry so the CLI flags remain
 * consistent across all 5 agents and so a future generation-audit flow
 * can flip it on without new wiring.
 */
