/**
 * AEM (AEMaaCS / AMS) — Requirements Authoring Engine (Phase 2.1 stub)
 * ====================================================================
  ...
  const findings: Finding[] = [
    {
      ...
      description:
        "Phase 2.1 scaffold. Content agent fills in Phase 2.2 (BRD template, Epic/Story/AC generators, AEM component vocabulary).",
      stack: STACK,
      category: "Authoring",
      severity: "INFO",
      source: "scanner",
