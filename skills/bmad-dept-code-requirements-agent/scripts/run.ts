...
function printHelp(): void {
  console.log(`
BMAD Requirements Agent (Phase 2.1 scaffold)
...
// ---------------------------------------------------------------------------
// BRD writer — Phase 2.1 minimal Markdown writer (docx lands in Phase 2.2)
// ---------------------------------------------------------------------------
...
function writeBrdMarkdown(
  ...
  lines.push("");
  lines.push(`_Generated by BMAD Requirements Agent — Phase 2.1 scaffold._`);
  ...
  lines.push("");
  lines.push(
    "Phase 2.2 populates real Epic → Story → AC content per stack, adds the docx writer, and wires template selection.",
  );
  lines.push("");
