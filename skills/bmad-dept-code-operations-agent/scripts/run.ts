...
function printHelp(): void {
  console.log(`
BMAD Operations Agent (Phase 3.4 scaffold)
...
function writeOperationsIndex(
  ...
  lines.push("");
  lines.push(`_Generated by BMAD Operations Agent — Phase 3.4 scaffold._`);
  ...
  lines.push("");
  lines.push(
    "Phase 3.5 populates real runbook / dashboard / alert / SLO / on-call / playbook / postmortem content per stack.",
  );
  lines.push("");
