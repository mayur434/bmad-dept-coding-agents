/**
 * AEM (AEMaaCS / AMS) — Release Authoring Engine (Phase 3.1 stub)
 * =================================================================
  ...
  const findings: Finding[] = [
    {
      ...
      description:
        "Phase 3.1 scaffold. Content agent fills this in Phase 3.2 (CI/CD pipeline templates, release-notes generators from commit history, deploy/rollback plans, env-diff calculations, stakeholder announcements, and aem-native deploy idioms).",
      stack: STACK,
      category: "Release",
      severity: "INFO",
      source: "scanner",
